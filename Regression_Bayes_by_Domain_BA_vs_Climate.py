...
for j in range(19):
    if (j+1 == 15 or j+1 == 3):
        continue
    X = dataset.iloc[:, [15, 3, j+1]].values
...
for j in range(19):
    if (j+1 == 3 or j+1 == 9 or j+1 == 15):
        continue
    X = dataset.iloc[:, [3, 9, 15, j+1]].values
...
for j in range(19):
    if (j+1 == 3 or j+1 == 9 or j+1 == 12 or j+1 == 15):
        continue
    X = dataset.iloc[:, [3, 9, 12, 15, j+1]].values
